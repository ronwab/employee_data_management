  ...
  database.ref().on("child_added", function(childsnapshot) {
    ...
    $("#full-member-list").append(
      "<div class='well'><span class='member-name'> " +
        ...
        " </span><span id='User-position'> " +
        childsnapshot.val().userPositin +
        " </span><span id='User-startDate'> " +
        childsnapshot.val().userStartDate +
        " </span><span id='User-wage'> " +
        childsnapshot.val().userWage +
        " </span></div>"
    );
  });
